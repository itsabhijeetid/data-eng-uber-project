CREATE OR REFRESH STREAMING TABLE uber.silver.silver_obt AS
SELECT
    stg_rides.ride_id,
...
FROM
    STREAM(uber.silver.stg_rides) WATERMARK booking_timestamp DELAY OF INTERVAL 3 MINUTES stg_rides
