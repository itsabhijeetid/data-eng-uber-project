...
# Empty Streaming Table -- (will load intial history + stream table) 
dp.create_streaming_table("uber.silver.stg_rides") # will have complete data

# Bulk/Initial Load
@dp.append_flow(
  target = "uber.silver.stg_rides"
  ) 
# History load
def rides_bulk():
